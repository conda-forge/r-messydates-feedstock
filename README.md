...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-messydates-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-messydates-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-messydates
# for installing globally
pixi global install r-messydates
```
...
It is possible to list all of the versions of `r-messydates` available on your platform:
...
```
pixi search r-messydates --channel conda-forge
```
